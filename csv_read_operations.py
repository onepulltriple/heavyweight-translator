...
#     previous_key = None #"supercalifragilisticexpialidocious"
...
#         if (current_key in translation_dict # this key is in the dictionary
#             and current_key != previous_key # and this key's value has not already been updated
#             #and current_key != previous_cons_run_key # this key is not a consolidated run's key
#             ): 
...
#             # Insert its translation
#             translation_dict[previous_key]['consolidated_runs'][current_key]['cons_run_translated_text'] = current_value
#             #previous_cons_run_key = current_key 
