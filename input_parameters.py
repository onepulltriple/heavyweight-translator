...
# path_to_source_document = r"N:\example_output_folder_name\subfolder_name\Admin_Datenbankstruktur.docx"
# path_to_output_folder   = r"N:\example_output_folder_name\subfolder_name"
# In Microsoft Windows, Shift + Right-click on source document, then select 'Copy as path'
path_to_source_document = r"N:\test_zentralen\test_Handbuch für Administratoren.docx"
path_to_output_folder   = r"N:\test_zentralen\filialen"
