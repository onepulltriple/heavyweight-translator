...
###########################################################################
# FILE PATHS
parent_source_document_path             = FO.clean_up_file_paths(IP.path_to_source_parent_document)
path_to_copy_of_source_parent_document  = cleaned_up_path_to_output_parent_folder + "/" + source_document_file_name_no_extension + "__" + IP.source_lang_cult + ".docx"
...
def handle_source_file_paths(path_to_source_document, path_to_output_folder, file_path_dictionary = {}):
    ...
    document_components_folder_path         = FO.clean_up_file_paths(os.path.join(any_parent_output_folder_path, source_document_file_name_no_extension))
