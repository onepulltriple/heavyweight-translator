...
source_document_path                   = IP.full_path_to_source_document
...
output_document_path                   = IP.full_path_to_output_folder + "\\" + source_document_file_name_no_extension + "__" + IP.target_lang_cult + ".docx"
